...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\p00688\\Documents\\PsychoPy\\IAT_SENSE\\IAT.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    score_meaning = visual.TextStim(win=win, name='score_meaning',
        text="Un score positif indique que vous avez tendance à associer les hommes aux sciences et les femmes aux lettres. Plus il est élevé, plus les associations sont fortes. \nA l'inverse, un score négatif indique une association forte entre les femmes et les sciences et les hommes et les lettres. ",
        font='Arial',
    ...
    while continueRoutine:
        ...
        if welcome_end.status == NOT_STARTED and t >= 0-frameTolerance:
            # keep track of start time/frame for later
    ...
    for thisBlock in blocks:
        ...
        for thisTrial in trials:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            # Run 'Begin Routine' code from check
            ...
            # keep track of which components have finished
            trialComponents = [text_stim, trial_cat_left, trial_cat_right, keyboard_resp, fixation]
            ...
            while continueRoutine:
                ...
                frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
                # update/draw components on each frame
                # Run 'Each Frame' code from check
                if keyboard_resp.corr == 1:
