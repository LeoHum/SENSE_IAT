...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if (fast_responses / total_responses) > 0.1:
        ...
        if 0 <= iat_score <= 0.5:
            feedback_msg = "Un score compris entre 0 et 0.5 traduit des associations stéréotypiques entre masculin et science et féminin et lettres."
        elif -0.5 <= iat_score < 0:
            feedback_msg = "Un score négatif compris entre -0,5 et 0 traduit des associations contre-stéréotypiques entre féminin et science et masculin et lettres."
        elif iat_score < -0.5:
    ...
    # keep track of which components have finished
    scoreComponents = [score_feedback, end_score, err_feedback, adapted_fb, skip_score]
    ...
    # keep track of which components have finished
    score2Components = [score_meaning_2, end_score_2]
